...
def process_video(video_path, input_method):
    ...
    out = cv2.VideoWriter(os.path.join(output_dir, 'output_video.mp4'), fourcc, 30.0, (640, 480))
    ...
    if input_method == 1:
        ...
        cap = cv2.VideoCapture(0, backend)  # Camera input
...
def select_video():
    ...
    if not os.path.exists(video_path):
        print("Default eye_test.mp4 not found. Please select a video file.")
